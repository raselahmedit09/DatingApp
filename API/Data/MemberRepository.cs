...
public class MemberRepository : GenericRepository<Member>, IMemberRepository
{
    ...
    {
        return await _dataContext.GetListAsync<Member>("SELECT M.Id,M.KnownAs,M.City,MP.PhotoUrl, M.UserId FROM Members AS M LEFT JOIN MemberPhotos AS MP ON M.Id = MP.MemberId AND MP.IsMain = 1");
